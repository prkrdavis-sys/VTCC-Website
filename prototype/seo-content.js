window.VTCC_SEO = {
  ...
  "pages": {
    ...
    "https://vtcc.health/early-learners/": {
      ...
      "description": "VTCC’s Early Learners program supports preschool-aged children as they build skills for school and social settings.",
      "headLines": [
    ...
    "https://vtcc.health/feeding-program/": {
      ...
      "description": "VTCC’s Feeding Program uses ABA practices to help children expand their food repertoire and preferences.",
      "headLines": [
    ...
    "https://vtcc.health/social-enrichment/": {
      ...
      "description": "VTCC’s Social Enrichment program, led by Brieanna Rollocks, BCaBA, helps children ages 8-12 practice peer skills in a supported group.",
      "headLines": [
    ...
    "https://vtcc.health/social-skills-group/": {
      ...
      "description": "VTCC’s Social Skills Group helps clients practice advanced social skills, including sarcasm and age-appropriate peer play.",
      "headLines": [
    ...
    "https://vtcc.health/group-parent-training/": {
      ...
      "description": "VTCC’s Group Parent Training, led by Olivia Roth, helps caregivers learn practical strategies together in a supported group setting.",
      "headLines": [
    ...
    "https://vtcc.health/programa-primeros-aprendices/": {
      ...
      "description": "El programa de Primeros Aprendices de VTCC apoya a niños en edad preescolar para prepararse para la escuela y los entornos sociales.",
      "headLines": [
    ...
    "https://vtcc.health/programa-alimentacion/": {
      ...
      "description": "El Programa de Alimentación de VTCC utiliza prácticas ABA para ayudar a los niños a ampliar su repertorio y sus preferencias alimentarias.",
      "headLines": [
    ...
    "https://vtcc.health/enriquecimiento-social/": {
      ...
      "description": "El programa de Enriquecimiento Social de VTCC, liderado por Brieanna Rollocks, BCaBA, ayuda a niños de 8 a 12 años a practicar habilidades con compañeros en un grupo con apoyo.",
      "headLines": [
    ...
    "https://vtcc.health/grupo-habilidades-sociales/": {
      ...
      "description": "El Grupo de Habilidades Sociales de VTCC ayuda a los clientes a practicar habilidades sociales avanzadas y juego apropiado para su edad con compañeros.",
      "headLines": [
    ...
    "https://vtcc.health/capacitacion-grupal-para-padres/": {
      ...
      "description": "La Capacitación Grupal para Padres de VTCC, liderada por Olivia Roth, ayuda a los cuidadores a aprender estrategias prácticas en un entorno grupal con apoyo.",
      "headLines": [
